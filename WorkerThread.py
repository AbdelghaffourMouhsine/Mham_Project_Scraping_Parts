...
class WorkerThread(threading.Thread):
    ...
    def __init__(self, thread_id, shared_list, proxyLoader,start_brand=None, start_year=None, start_model=None, start_elem_X=None, start_elem_XX=None, start_part_name=None, end_brand=None,end_year=None,end_model=None,end_elem_X=None,end_elem_XX=None,end_part_name=None):
